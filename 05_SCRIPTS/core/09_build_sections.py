...
hook_style = project.get("lyric_style_hook", "hook_highlight")
sections = []
t = 0
...
sections.append({"label":"hook_a","start":t,"end":t+sp["hook_a_sec"],"loop_variant":"loop_glow_breath.mp4","lyric_style":hook_style}); t += sp["hook_a_sec"]
sections.append({"label":"body_b","start":t,"end":t+sp["body_b_sec"],"loop_variant":"loop_vignette_pulse.mp4"}); t += sp["body_b_sec"]
sections.append({"label":"climax","start":t,"end":t+sp["climax_sec"],"loop_variant":"loop_climax_lift.mp4","lyric_style":hook_style}); t += sp["climax_sec"]
